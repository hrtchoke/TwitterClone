...
import cloudinary
cloudinary.config( 
  cloud_name = "dt7cjqkj8", 
  api_key = "321769837273379", 
  api_secret = "V6BwGX2VXyJ3PnV-gTK7mNpOvCY" 
)
...
SECRET_KEY = 'django-insecure-0at794lgqk)iu593q(ga5cjv1f9e@3j92se6yz5uc$x43$hwf4'
